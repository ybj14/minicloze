...
pub fn corpus_for_language(language: &str) -> Option<LocalCorpus> {
    match language {
        ...
        "amh-a1" => Some(LocalCorpus {
            base_language: "amh",
            json: include_str!("../corpora/amharic_a1.json"),
        }),
        "amh-swadesh" => Some(LocalCorpus {
            base_language: "amh",
        ...
        "kat-a1" => Some(LocalCorpus {
            base_language: "kat",
            json: include_str!("../corpora/georgian_a1.json"),
        }),
        "kat-swadesh" => Some(LocalCorpus {
            base_language: "kat",
...
pub fn vocabulary_for_language(language: &str) -> Option<LocalVocabulary> {
    match language {
        ...
        "amh-a1" => Some(LocalVocabulary {
            json: include_str!("../corpora/amharic_a1_vocab.json"),
        }),
        ...
        "kat-a1" => Some(LocalVocabulary {
            json: include_str!("../corpora/georgian_a1_vocab.json"),
        }),
...
fn explanations_for_language(language: &str) -> Option<LocalExplanations> {
    match language {
        ...
        "amh-a1" => Some(LocalExplanations {
            json: include_str!("../corpora/amharic_a1_explanations.json"),
        }),
        ...
        "kat-a1" => Some(LocalExplanations {
            json: include_str!("../corpora/georgian_a1_explanations.json"),
        }),
